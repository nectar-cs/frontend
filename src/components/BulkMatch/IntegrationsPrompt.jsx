...
class IntegrationsPromptClass extends React.Component<Props> {
  ...
  renderConnectButton() {
    return <Button.FixedSmallButton onClick={this.showOffer}>Connect</Button.FixedSmallButton>;
  }
...
const IntegrationPrompt = ModalClientComposer.compose(IntegrationsPromptClass);
