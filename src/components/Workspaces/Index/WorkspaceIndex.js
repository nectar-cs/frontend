...
class WorkspaceIndexClass extends React.Component {
  ...
  renderWorkspacesList() {
    return this.state.workspaces.map(w => <WorkspaceRow key={w.id} {...w} />);
  }
...
function WorkspaceRow(props) {
  ...
  return (
    <tr>
      ...
      <td>
        <p>
          <Text.BoldStatus>{props.is_default.toString()}</Text.BoldStatus>
        </p>
      </td>
      <td>
        <ColoredLabelList labelType={props.ns_filter_type} labels={props.ns_filters} />
      </td>
      <td>
        <ColoredLabelList labelType={props.lb_filter_type} labels={props.lb_filters} />
      </td>
      <td>
        <Layout.TextLine>
          <Link to={editPath}>
...
const WorkspaceIndex = AuthenticatedComponent.compose(
  ModalHostComposer.compose(ErrComponent.compose(WorkspaceIndexClass)),
);
