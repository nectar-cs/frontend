...
class CheatSheetFormFunc extends React.Component<Props> {
  ...
  renderApiSelect() {
    return this.props.makeSelectItem('api', Utils.arrayOfHashesOptions(defaults.apiChoices));
  }
...
const CheatSheetForm = FormComponent.compose(CheatSheetFormFunc);
