const upcoming = {
  ...
  observatory: {
    ...
    info: [
      "Useful representations of a cluster's contents."
    ]
  },
  ...
  compliance: {
    ...
    info: [
      "For proving to ourselves and others that our Reg Tests " +
      " actually get run and pass."
    ],
  },
  ...
  costPolicyAnalysis: {
    ...
    info: [
      "See which remote-cluster-based development day are costing the most."
    ]
  }
};
